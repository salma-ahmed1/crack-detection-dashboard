...
function createRoadSelector(array) {
  ...
  document.getElementsByClassName("d-flex")

  let x = document.createElement("input")
  x.setAttribute("class", "form-control me-2")
  x.setAttribute("placeholder", "Search")
  x.setAttribute("id", "searchBox")
  x.setAttribute("onkeyup", "searchFun()")
  x.setAttribute("style", "color: white; background-color: #515265;")
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    el.setAttribute("style", "background-color: #070923")
    el.textContent = opt;
    el.value = opt;
    select.appendChild(el);
  }
...
function searchFun(list) {
  var yesFinal = document.getElementById("RoadSelector")
  yesFinal.removeChild
  searchInbox = document.getElementById('searchBox')
  var hello = document.getElementById("RoadSelector");
  var listItem = document.createElement("li");
  listItem.setAttribute("class", "dropdown-item");
  listItem.setAttribute("id", "roadchart");
  listItem.setAttribute("style", "background-color: #070923")
  ...
  for (k = 0; k < roads.length; k++) {
    ...
    hello.appendChild(listItem);
    console.log(roads[k])
    console.log(listItem)
  }
  console.log('newwwwwwww', roads)
}